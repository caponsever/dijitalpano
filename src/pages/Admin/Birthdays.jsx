...
const BirthdayAdmin = () => {
    ...
    const addRow = () => {
        ...
        setList([...list, { id: newId, name: '', date: new Date().toISOString().split('T')[0] }]);
    };
    ...
    const handleSave = () => {
        updateBirthdays(list);
        alert('Doğum günü listesi kaydedildi!');
    };
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-gray-800">Doğum Günleri</h2>
                ...
                <table className="w-full text-left">
                    <thead>
                        <tr className="border-b bg-gray-50">
                            <th className="p-3 font-medium text-gray-600">Ad Soyad</th>
                            <th className="p-3 font-medium text-gray-600">Doğum Tarihi</th>
